...
function  menuopen(){
    ...
    document.querySelector(".op1").style=" display: grid; width: 94%;text-align: center;padding:20px;font-size:2vw"
    document.querySelector(".op2").style=" display: grid; width: 94%;text-align: center;padding:20px;font-size:2vw"
    document.querySelector(".op3").style=" display: grid;width: 94%;text-align: center;padding:20px;font-size:2vw"
    document.querySelector(".op4").style=" display: grid;width: 94%;text-align: center;padding:20px;font-size:2vw"
    document.querySelector(".x").style="visibility: visible; display: grid;margin: 20px;background-color: #cc9543 !important;";
